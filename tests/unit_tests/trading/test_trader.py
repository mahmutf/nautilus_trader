...
class TestTrader:
    ...
    def test_generate_account_report_with_account_id_priority_over_venue(self) -> None:
        ...
        report = self.trader.generate_account_report(venue=Venue("BINANCE"), account_id=account_id_1)
    ...
    def test_generate_account_report_raises_when_both_none(self) -> None:
        # Arrange & Act & Assert
        with pytest.raises(ValueError, match="At least one of 'venue' or 'account_id' must be provided"):
