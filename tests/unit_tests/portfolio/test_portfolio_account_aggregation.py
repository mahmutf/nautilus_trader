...
class TestPortfolioAccountAggregation:
    ...
    def test_net_exposure_sums_across_multiple_accounts(self):
        ...
        exposure_1 = self.portfolio.net_exposure(BTCUSDT_BINANCE.id, price=current_price, account_id=self.account_id_1)
        exposure_2 = self.portfolio.net_exposure(BTCUSDT_BINANCE.id, price=current_price, account_id=self.account_id_2)
    ...
    def test_unrealized_pnl_with_explicit_price_sums_across_multiple_accounts(self):
        ...
        pnl_1 = self.portfolio.unrealized_pnl(BTCUSDT_BINANCE.id, price=current_price, account_id=self.account_id_1)
        pnl_2 = self.portfolio.unrealized_pnl(BTCUSDT_BINANCE.id, price=current_price, account_id=self.account_id_2)
